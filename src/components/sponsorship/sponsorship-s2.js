    ...
    return (
        <div className="min-h-[55vh] font-RobotoMono my-[7.5%] w-[80%] mx-auto">
            <div className="flex justify-center">
                <div className="w-[47.5%] relative inline-block mr-[5%] style={{ maxWidth: '47.5%' }}">
                    {/* <img src={ShadowTeamPhoto} alt="Shadow Team" className="absolute top-[20px] left-[-20px] z-0 rounded-[14px]" style={{ width: '100%', height: 'auto', backgroundColor: '#8cbc24' }} /> */}
                    <div className="absolute top-[20px] left-[-20px] z-0 rounded-[14px] bg-[#8cbc24]" style={{ width: '100%', height: '120%', zIndex: 0 }} />
                ...
                <div className="w-[47.5%] flex flex-col justify-center">
                    ...
                    <div className="flex justify-center">
                        ...
                        {/* changed background color of Sponsorship Package  */}
                        <a href={`${process.env.PUBLIC_URL}/assets/UBC-AgroBot-Sponsorship-Package-2020-1.pdf`} target="_blank" rel="noopener noreferrer" className="p-4 w-auto rounded-[14px] bg-[#8cbc24] text-black font-bold flex justify-center items-center">
                            {S2ButtonText} <MdChevronRight />
                        </a>
                    </div>
                </div>
