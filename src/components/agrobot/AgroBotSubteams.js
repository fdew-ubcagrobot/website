...
function AgroBotSubteams() {
    ...
    return (
        <div className='w-[80%] mx-auto my-[20vh] font-Inter'>
            ...
            <Subteam bgColor='#351C1F' hlights={chassHlights} text={chassText}>Chassis</Subteam>
            <Subteam bgColor='#1E1612' hlights={extHlights} text={extText}>Extermination</Subteam>
            <Subteam bgColor='#271f30' hlights={navHlights} text={navText}>Navigation</Subteam>
            <Subteam bgColor='#351C1F' hlights={appAIHlights} text={appAIText}>Applied AI</Subteam>
        </div>
    );
}
